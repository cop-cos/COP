# COSCO Syncon Hub API Specification for Channel-L/COSCO Shipping Query
...
* **Path**: /service/synconhub/product/channel-l-cosco-shipping/search
* **Method**: POST
...
* **Path**: /service/synconhub/product/channel-l-cosco-shipping/{productId}
* **Method**: GET
