# COSCO Syncon Hub API Specification for Channel-L/COSCO Shipping Booking
...
* **Path**: /service/synconhub/shipment/channel-l-cosco-shipping/booking
* **Method**: POST
...
| loadingServiceNo         |  String  |    no    | Get from the result of the Intermodal service query interface. |                                               |
| dischargeServiceNo       |  String  |    no    | Get from the result of the Intermodal service query interface. |                                               |
...
- **Path**: /service/synconhub/order/channel-l-cosco-shipping/search
- **Method**: POST
