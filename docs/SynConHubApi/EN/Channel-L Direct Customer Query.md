...
```http
GET /service/synconhub/product/channel-l-direct-customer/8a5e11157351b2df01735562622a0000
```

```http
GET /service/synconhub/product/channel-l-direct-customer/8a5e11157351b2df01735562622a0000?loadingServiceNo=8a5e112478d41b380178d4551a33000a
```

```http
GET /service/synconhub/product/channel-l-direct-customer/8a5e11157351b2df01735562622a0000?loadingServiceNo=8a5e112478d41b380178d4551a33000a&dischargeServiceNo=8a5e112478c4eed60178c51cca9f0001
```
